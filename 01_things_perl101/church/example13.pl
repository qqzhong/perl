...
use diagnostics;
# perl -Mdiagnostics example13.pl;

# The confess function in Perl is like cluck;
# it calls die and then prints a stack trace all the way up to the origination script.
use Carp qw( confess );
$SIG{__DIE__}  = \&confess;
$SIG{__WARN__} = \&confess;

# use Carp::Always;
# perl -MCarp::Always example13.pl;
sub ro {
  my $filename = 'hell.txt';
...
# f="/data/2022/perl/01_things_perl101/church/example13.pl";perltidy -ce -l=128 -i=2 -nbbc -b ${f};
