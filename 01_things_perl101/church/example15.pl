...
sub ro {
  my $rc = system("ls -ls");    # returns exit status values
  ...
  # replace `` or qx with "IPC::Open2 or IPC::Open3";
}
...
# chapter15:external-programs
# Sun 12 Jun 2022 12:38:31 PM HKT
# f="/data/2022/perl/01_things_perl101/church/example15.pl";perltidy -ce -l=128 -i=2 -nbbc -b ${f};
