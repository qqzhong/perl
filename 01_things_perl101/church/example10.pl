...
sub example {
  ...
  # better;
  my $file_as_string1 = do {
    open( $fh, $filename ) or die "Can't open $filename: $!";
    local $/ = undef;
    <$fh>;
  };
  print("file_as_string1=\n$file_as_string1\n");

  # faster;
  # sudo apt-get install libfile-slurp-perl -y;
  use File::Slurp qw( read_file );
  my $file_as_string2 = read_file($filename);
  print("file_as_string2=\n$file_as_string2\n");
...
# f="/data/2022/perl/01_things_perl101/church/example10.pl";perltidy -ce -l=128 -i=2 -nbbc -b ${f};
