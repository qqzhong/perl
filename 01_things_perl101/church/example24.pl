...
sub ro {
  my $fh;
  # eat up all your available memory by reading entire file;
  for (<$fh>) {
    # do something
  }
  ...
  # my $copy = "$large_string";# BAD: two big string;
  # my $copy = $large_string; # GOOD: one big string;
...
# chapter24:performance
# Sun 12 Jun 2022 12:38:31 PM HKT
# f="/data/2022/perl/01_things_perl101/church/example24.pl";perltidy -ce -l=128 -i=2 -nbbc -b ${f};
