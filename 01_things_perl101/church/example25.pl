...
sub ro {
  # This doesn't normally happen if you're dealing with file reading (unless you've modified $/), but it's possible.
...
# f="/data/2022/perl/01_things_perl101/church/example25.pl";perltidy -ce -l=128 -i=2 -nbbc -b ${f};
