...
sub example {
  ...
  if ( sprintf( "%f", 0.2 * 12 ) eq sprintf( "%f", 2.4 ) ) {
    print "[sprintf]These are equal.\n";
  } else {
    print "[sprintf]These are not equal.\n";
  }

  printf( "BAD = %.3f\n", int(3.1415926535) );    # prints 3
  printf( "%.3f\n",       3.1415926535 );         # prints 3.142
...
# f="/data/2022/perl/01_things_perl101/church/example05.pl";perltidy -ce -l=128 -i=2 -nbbc -b ${f};
