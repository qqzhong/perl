...
sub ro {
  system('perl turntohash.pl --n1=v1 -n=v --n2=v2 -k=v');

  # This sets the variable $debug inside the script myscript.pl to the value 1.
  # perl -s -debug -- myscript.pl
  # perl -s -debug = 2 -- myscript.pl

  # perl -e 'print while <>' file1.txt file2.tx
...
# chapter14:Chapter 14 Command Line and Shell Interaction
# Sun 12 Jun 2022 12:38:31 PM HKT
# f="/data/2022/perl/00_professional_perl_programming/church/example14.pl";perltidy -ce -l=128 -i=2 -nbbc -b ${f};
